...
def model(Y, T, params):
	...
	prog_n_B=2
	prog_delta_C=0.1
	dB_dt=+prog_alpha_B*activate_1(i1,prog_Kd_B,prog_n_B)-prog_delta_B*B
	dC_dt=+prog_alpha_C*activate_1(i2,prog_Kd_C,prog_n_C)-prog_delta_C*C
	dA_dt=-prog_delta_A*A
	cond0=A
	cond1=A
	RESET0=0 if T > 1 else 100
	SET0=max((inhibition(i1, cond0, KD_cond),)) 
	RESET1=0 if T > 1 else 100
	SET1=max((induction(i2, cond1, KD_cond),)) 
